...
**Launch the MoveIt assistant tool**
```bash
...
└── src/
    ...
    │       ├── basic_robot.ros2_control.xacro   # ros2_control hardware interface
    │       ├── common_properties.xacro          # Common URDF properties
    │       └── gripper.xacro                    # Gripper description macros
    │
    ├── ros2_moveit_config_template/    # MoveIt2 configuration package (generated by Setup Assistant)
    │   ├── CMakeLists.txt
    │   ├── package.xml
    │   ├── .setup_assistant
    │   ├── config/
    │   │   ├── basic_robot.ros2_control.xacro   # ros2_control hardware interface
    │   │   ├── basic_robot.srdf                 # Semantic Robot Description (planning groups, poses)
    │   │   ├── basic_robot.urdf.xacro           # Robot URDF for MoveIt
    ...
    │   │   └── sensors_3d.yaml                  # 3D sensors configuration
    │   └── launch/
    │       ├── demo.launch.py                   # Full demo launch (RViz + MoveGroup)
    │       ├── move_group.launch.py             # MoveGroup node launch
    ...
    │
    ├── ros2_moveit_bringup/            # MoveIt2 bringup package (launch all nodes)
    │   ├── CMakeLists.txt
    │   ├── package.xml
    │   ├── config/
    │   │   └── ros2_controllers.yaml            # ros2_control controllers config
